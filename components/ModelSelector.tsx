...
import { placementIdFromObject } from "@/lib/modelPlacement";
...
export function ModelSelector({
  ...
  const selectingModel = useRef(false);
  ...
  const pickModelPlacement = useCallback(
  ...
  useEffect(() => {
    ...
    const onDown = (e: PointerEvent) => {
      ...
      const hitId = pickModelPlacement(e.clientX, e.clientY);
      if (!hitId) {
    ...
    const onUp = (e: PointerEvent) => {
      ...
      const wasSelecting = selectingModel.current;
      pending.current = false;
      dragging.current = false;
      selectingModel.current = false;
